...
@section('Breadcrumb')
    <div class="flex justify-between w-full flex-col lg:flex-row ">
        <div>
            ...
            <nav class="col-span-2">
                <ol class="list-reset py-4 pl-2 rounded flex bg-grey-light text-grey">
                    ...
                    <li class="px-2">/</li>
                    <li class="text-gray-400">新增規格</li>
                </ol>
            </nav>
        ...
        <div>
            ...
            <button v-on:click="sentCreateOrNot()" class="btn btn-fourth btn-rwd">新增</button>
...
@section('content')
    ...
    <form ref="form_save_edit" action="{{ route('admin_product_type.CreateType') }}" method="POST">
        @csrf
