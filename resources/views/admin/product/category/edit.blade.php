...
@section('Breadcrumb')
    <div class="flex justify-between w-full flex-col lg:flex-row ">
        ...
        <div>
            ...
            <button v-on:click="sentCreateOrNot()" class="btn btn-sec btn-rwd">送出</button>
...
@section('content')
    <form ref="form_save_edit" action="{{ route('admin_product_category.update', $category->id) }}" method="POST"
        ...
        <div class="p-4 shadow-md rounded-md text-left max-w-5xl mx-auto border-solid border border-gray-300">
            ...
            <label v-if="show_reupload" class="block mt-4">
                <span class="text-gray-700">類別圖片</span>
            ...
            <div v-else class="my-2">
              ...
              <a href="{{route('picuploadPage', ['w'=>500,'h'=>350,'path'=>$category->img_url, 'back_url'=>route('admin_product_category.edit', ['admin_product_category' => $category->id])])}}">
