...
@section('classification-name', '編輯商品')
        ...
        <div>
            ...
            <nav class="col-span-2">
                <ol class="list-reset py-4 pl-2 rounded flex bg-grey-light text-grey">
                    ...
                    <li class="px-2">/</li>
                    <li><a href="{{ route('admin_product.show', ['admin_product' => $product->id]) }}" class="no-underline text-blue-400">{{$product->name}}</a>
                    </li>
                      <li class="px-2">/</li>
...
@section('content')
    <form ref="form_save_edit" action="{{ route('admin_product.update',['admin_product'=> $product->id]) }}" method="POST"
        ...
        <div class="p-4 shadow-md rounded-md text-left max-w-5xl mx-auto border-solid border border-gray-300">
            ...
            <div class="block mt-4">
                ...
                <textarea class="hidden" id="textarea_description"
                    name="description">{{ old('description', $product->description) }}</textarea> <br>
            </div>
