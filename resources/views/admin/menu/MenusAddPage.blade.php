...
@section('content')
    ...
    <form action="{{ route('MenusAdd') }}" method="post">
        <div class=" p-5 bg-white rounded shadow">
            ...
            <div>
                ...
                <input placeholder="輸入要在選單上顯示名稱" name="name" value="{{ old('name') }}"
            ...
            <div class="mt-3">
                ...
                <input placeholder="輸入點擊後要前往的連結" name="link" value="{{ old('link') }}"
                    class="ml-2 px-4 py-3 leading-5 border rounded-md focus:outline-none focus:ring focus:border-blue-400 w-full lg:w-60"
                    type="text" id="link" />
            </div>
                ...
                <div class="mt-1.5 ml-4 lg:ml-3 lg:mt-0">
                    <div class="flex ">
                        <label class="flex items-center">
                            <input {{ (! empty(old('desktop')) ? 'checked' : '') }} name="desktop" type="checkbox" class="form-checkbox">
                    ...
                    <div class="flex mt-2">
                        <label class="flex items-center">
                            <input  {{ (! empty(old('phone')) ? 'checked' : '') }}  name="phone" type="checkbox" class="form-checkbox">
