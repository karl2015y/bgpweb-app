...
@section('content')
    ...
    <form action="{{ route('ComponentsAdd') }}" method="post">
        <div class=" p-5 bg-white rounded shadow">
            ...
            <div>
                ...
                <input placeholder="輸入元件的顯示名稱" name="name" value="{{ old('name') }}"
            ...
            <div class="mt-3">
                ...
                <input placeholder="輸入元件對應的程式名稱" name="show_name" value="{{ old('show_name') }}"
                    class="ml-2 px-4 py-3 leading-5 border rounded-md focus:outline-none focus:ring focus:border-blue-400 w-full lg:w-60"
            ...
            <div class="mt-3">
                ...
                <div class="flex lg:inline-block w-full lg:w-96">
                    <div class="mx-3 lg:ml-10 lg:mr-0 relative inline-block w-full lg:w-60 text-gray-700">
                        <select 
                            @change="toggleClassificationChooseStatus()"
                            v-model="classification_selected"
                ...
                <div class="ml-4 mt-2 lg:ml-32 lg:mt-3">
                    ...
                    <input name="component_classifies" class="hidden" type="text" :value="choose_classifications_list">
                </div>
            </div>
