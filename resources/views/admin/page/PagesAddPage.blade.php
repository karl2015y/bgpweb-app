...
@section('content')
    ...
    <form action="{{ route('PagesAdd') }}" method="post">
        <div class=" p-5 bg-white rounded shadow">
            ...
            <div>
                ...
                <input placeholder="輸入該頁面上方與Google上顯示的名稱" name="title" value="{{ old('title') }}"
            ...
            <div class="mt-3">
                ...
                <input placeholder="輸入該頁面專屬的連結" name="url" value="{{ old('url') }}"
                    class="ml-2 px-4 py-3 leading-5 border rounded-md focus:outline-none focus:ring focus:border-blue-400 w-full lg:w-80"
                    type="text" id="url" />
            </div>
