                    ...
                    <div>
                        ...
                        @else
                            <form method="post" action="{{ route('useCoupon') }}"
                                ...
                                @csrf
                                <div class="flex bg-gray-100 p-4 w-full lg:w-80 mt-3 space-x-4">
                                ...
                                <button
                                    class="text-center px-3 py-2 bg-brown text-white text-sm font-medium  hover:bg-blue-500 focus:outline-none focus:bg-blue-500">
                                    <span>套用</span>
                                </button>
                            </form>
                        @endif
